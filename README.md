# RUEN — AI-сервис оценки качества DICOM-исследований плотности костей
...
Этот репозиторий на текущем этапе содержит **production-like каркас**: API, UI, ML-сервис и Docker. Бизнес-логика, модель и обработка DICOM намеренно не реализованы.
